...
from model_ECRN import ECRN_50
...
parser.add_argument('-a', '--arch', metavar='ARCH', default='ECRN_50',
...
parser.add_argument('-b', '--batch-size', default=32, type=int,
                    metavar='N',
                    help='mini-batch size (default: 299), this is the total '
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if 'efficientnet' in args.arch:  # NEW
        ...
        if args.pretrained:
            ...
            elif args.arch.find('ECRN_50') != -1:  # ResNet
                model = ECRN_50() 
            else:
    ...
    #criterion = nn.CrossEntropyLoss(weight=torch.Tensor([1, 1.5 , 2.5])).cuda(args.gpu)
    # use_cuda = True
    ...
    if args.advprop:
        ...
        normalize = transforms.Normalize(mean = [0.23832342, 0.1903435, 0.11086617], 
                                          std = [0.27353868, 0.22995637, 0.1565411])
